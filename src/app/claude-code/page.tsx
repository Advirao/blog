...
export const metadata: Metadata = {
  title: 'Claude Code',
  description:
    'Master Claude Code — the agentic CLI that writes, edits, and tests code autonomously. Covers the agentic loop, tools, hooks, skills, CLAUDE.md, and CI/CD integration.',
}

export default function ClaudeCodePage() {
  const posts = getPostsByCategory('claude-code')
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-3 mt-5">
            <span className="pill bg-purple/15 text-purple border border-purple/20">
              {posts.length} module{posts.length !== 1 ? 's' : ''}
            </span>
